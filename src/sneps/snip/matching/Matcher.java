...
import sneps.snip.rules.nodes.RuleNode;
...
public class Matcher {
	...
	private static boolean checkRuleCompatibility(MolecularNode sourceNode,
		...
		Class<? extends MolecularNode> sClass = sourceNode.getClass();
		Class<? extends MolecularNode> tClass = targetNode.getClass();
