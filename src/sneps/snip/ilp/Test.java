...
//		============================================================
		...
		posEv.addNode(node2);
		posEv.addNode(node3);
		NodeSet bgKnowledge = new NodeSet();
		bgKnowledge.addNode(node);
		bgKnowledge.addNode(node1);
		
		InductionEngine in = new InductionEngine();
		System.out.println("anti:");
		System.out.println(in.antiUnification.antiUnify(posEv));
		System.out.println("_______________");
		System.out.println(in.antiUnification.antiUnify(bgKnowledge));
		System.out.println("_______________");
		in.antiUnification.displayGeneralizationMap();
		System.out.println("_______________\n\n");
		
		in.initializePositiveEvidence(posEv);
		in.initializeBackgroundKnowledge(bgKnowledge);
		System.out.println("positive evidence:");
		InductionEngine.displayNodeSetTable(in.positiveEvidenceTable);
		System.out.println("\n");
		System.out.println("Background Knowledge:");
		InductionEngine.displayNodeSetTable(in.backgroundKnowledgeTable);
		System.out.println("===");
