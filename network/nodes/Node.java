...
import sneps.snip.channels.ChannelSet;
...
public class Node {
	...
	public Node(String syn, String sem, String name) throws Exception {
		Class s = Class.forName("sneps.network.classes.syntactic." + syn);
		Constructor con = s.getConstructor(new Class[] { String.class });
		this.syntactic = (Term) con.newInstance(name);
		Class s2 = Class.forName("sneps.network.classes.semantic." + sem);
