...
import sneps.network.PathTrace;
...
public class CFResBUnitPath extends Path{
	 ...
	 */
	private RelationsRestrictedCaseFrame caseFrame;
	 ...
	 */
	public CFResBUnitPath(Relation relation, RelationsRestrictedCaseFrame cf){
	 ...
	 * 	to.
	 */
	public RelationsRestrictedCaseFrame getCaseFrame(){
