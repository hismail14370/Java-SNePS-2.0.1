...
public class Network {
	 ...
	 *         given 2D array.
	 */
	public static MolecularNode getMolecularNode(ArrayList<Wire> wires) { 
	...
	public static boolean checkForBoundVariables(MolecularNode node){
		
		DownCableSet ds = node.getDownCableSet(); 
		Enumeration<DownCable> dCables = ds.getDownCables()
				.elements(); 
		while (dCables.hasMoreElements()) {
			DownCable dCable = dCables.nextElement(); 
			if(dCable.getRelation().isQuantifier()){
				return true;
			}
		}
	 ...
	 */
	public static MolecularNode buildMolecularNode(ArrayList<Wire> wires,
	...
	private static void print(LinkedList<Object[]> ns){
		if(ns.size() == 1){ 
			Object[] s = ns.get(0);
			System.out.println("Downcable set exist > "+s[0]);
			
		} 
		else 
			System.out.println("Downcable set does not exist");
	}
	...
	private static MolecularNode createPatNode(Object[][] relNodeSet,
		...
		String semantic = caseFrame.getSemanticClass();
...
//	 VariableNode node5 = new VariableNode("Entity", "z");
//	 NodeSet ns = new NodeSet();
//	 ns.addNode(node1);
//	 ns.addNode(node2);
//	 NodeSet ns1 = new NodeSet();
...
//		 MolecularNode m = buildMolecularNode(relNode, cf);
		 ...
		 Relation member = Network.defineRelation("member", "Entity"); 
		 Relation cl = Network.defineRelation("class", "Entity");  
		 Relation quant = Network.defineRelation("forall","Entity");
	     ...
	     Wire w8 = new Wire(cl, w4.getWireNode()); 
	     Wire w9 = new Wire(quant); 
	     Wire w10 = new Wire(member,w4.getWireNode()); 
	    ...
	    m2Wires.add(w4);
         ...
         MolecularNode m2 = Network.buildMolecularNode(m2Wires, cf);  
        System.out.println(m2);
      // System.out.println(molecularNodes.get(arg0));
	       ...
	       //////////////////////////////////////////////////////////////////////////////////
//	       Relation member = new Relation("member", "Entity", "reduce", 2); 
//		   Relation cl = new Relation("class", "Entity", "none", 2); 
//		   Entity e = new Entity();
//	       RCFP prop = Network.defineRelationPropertiesForCF(member, "none", 1);
//		   RCFP prop2 = Network.defineRelationPropertiesForCF(cl, "none", 1); 
//			 
//		   
//     	   LinkedList<RCFP> propList = new LinkedList<RCFP>(); 
//		   propList.add(prop);
//		   propList.add(prop2);  
//	     
//	       RelationsRestrictedCaseFrame cf2 = Network.defineCaseFrameWithConstraints("Entity", propList);  
//		
//	       Wire w1 = new Wire(member, "Mary","Base",e);  
//	       Wire w2 = new Wire(cl, "Young", "Base",e); 
//	       Wire w3 = new Wire(member,"Variable");  
//	       Wire w4 = new Wire(cl,"Variable");
//	     
//	       ArrayList<Wire> m2Wires = new ArrayList(); 
//	       m2Wires.add(w1); 
//	       m2Wires.add(w2);  
//	       m2Wires.add(w4); 
//	       
//	       MolecularNode m2 = Network.buildMolecularNode(m2Wires, cf2); 
//	       System.out.println(m2); 
